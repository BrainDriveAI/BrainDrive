...
Revision ID: 2f13980fc441
Revises: 
Create Date: 2025-04-03 08:21:02.629462
...
def upgrade() -> None:
	...
	created_at DATETIME DEFAULT (CURRENT_TIMESTAMP), 
	updated_at DATETIME DEFAULT (CURRENT_TIMESTAMP), is_system_route BOOLEAN, default_component_id VARCHAR(100), default_page_id VARCHAR(36), can_change_default BOOLEAN DEFAULT FALSE, 
	PRIMARY KEY (id), 
	...
	icon VARCHAR(50), 
	created_at DATETIME DEFAULT (CURRENT_TIMESTAMP), 
	updated_at DATETIME DEFAULT (CURRENT_TIMESTAMP), parent_type VARCHAR(50), is_parent_page BOOLEAN, 
	PRIMARY KEY (id), 
	FOREIGN KEY(creator_id) REFERENCES users (id), 
