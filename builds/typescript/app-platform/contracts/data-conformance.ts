...
export const MigrationCompatibilityPolicySchema = z
  .object({
    ...
    active_schema_version: z.literal(4),
    readable_schema_versions: z.tuple([z.literal(2), z.literal(3), z.literal(4)]),
    writable_schema_versions: z.tuple([z.literal(4)]),
