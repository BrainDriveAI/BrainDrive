...
export const AuditEventSchema = z
  .object({
    ...
    model_call_id: OpaqueIdSchema.nullable().optional(),
    ...
    owner_memory_transition: z.enum(["propose", "owner_confirm", "durable_write", "deny"]).nullable().optional(),
    owner_memory_outcome: z.enum(["proposed", "confirmed", "written", "denied"]).nullable().optional(),
