...
describe("GatewayProjectService uploads", () => {
  ...
  it("can place finance uploads in a statements subfolder and index the relative path", async () => {
    ...
    try {
      ...
      const index = await readFile(path.join(memoryRoot, "documents", "finance", "index.md"), "utf8");
      expect(index).toContain("| `statements/2026-05-capital-one.md` | Credit card statement | Capital One credit card statement for May 2026. | User asks about statements/2026-05-capital-one.md. | 2026-05-14T16:00:00.000Z |");
