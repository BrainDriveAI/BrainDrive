...
export function buildProjectChatContext(
  ...
  const financeParentGuidance = projectId === "finance"
    ? [
        ...
        "For retirement or investment boundaries, organize the tradeoff as an owner decision. Do not tell the owner to pause contributions temporarily or immediately, do not frame pausing as the obvious fast-debt lever, do not say contributions or earnings should stay invested, do not say hands off, locked out, let it compound, untouched, no pauses, or preserve those retirement assets, do not explain Roth withdrawal mechanics unless explicitly asked, do not say to throw cash at credit cards or burn down debt, and do not recommend specific funds, trades, securities, allocations, contributions, or withdrawals. If a Roth IRA boundary affects the plan, write both exact bullets: Owner Decisions: Roth IRA boundary: the Roth IRA is outside this short-term cash-flow plan unless the owner separately asks to review retirement contributions. Planning Guardrails: Roth IRA is not a funding source for this Finance plan. Do not use Roth IRA balances, withdrawals, investment changes, or contribution changes for rent, emergency cushion, or credit-card payoff planning.",
