...
export function buildProjectChatContext(
  ...
  const financeParentGuidance = projectId === "finance"
    ? [
        ...
        "Finance can complete Align + Plan without uploaded documents or a saved Budget. Use Budgeting only when the goal or plan needs category-level spending visibility or spending targets.",
        ...
        "If the owner adds material context after a Finance plan exists, especially a regulated-boundary term like Roth IRA, 401(k), tax, legal, insurance, or debt settlement, update the Finance plan under Owner Decisions or Planning Guardrails and read it back before saying the plan covers it.",
        ...
        "For parent Finance debt payoff, ask for credit-card statement/app evidence only as optional balance, APR, due-date, and minimum-payment evidence. Do not mention Budgeting, transaction review, spending analysis, reconciliation, or statement-period reconciliation in the same owner-facing reply as an attach/upload request. Keep Budgeting deferral in Your Plan unless the owner asks why Budgeting is not active.",
        "For retirement or investment boundaries, organize the tradeoff as an owner decision. Do not tell the owner to pause contributions temporarily or immediately, do not frame pausing as the obvious fast-debt lever, do not say contributions or earnings should stay invested, do not explain Roth withdrawal mechanics unless explicitly asked, do not say to throw cash at credit cards or burn down debt, and do not recommend specific funds, trades, securities, allocations, contributions, or withdrawals. If a Roth IRA boundary affects the plan, write this exact plan-scope sentence: The Roth IRA is not a funding source for this Finance plan.",
        ...
        "For sensitive Finance turns, keep chat compact: use no more than 80 words or 500 characters after artifact writes or high-stakes guidance, use at most three bullets, ask for at most three facts in one chat turn, never use markdown tables or the pipe character in chat, Finance spec, or Finance plan, put detailed constraints/tradeoffs/evidence labels in the Finance spec or Finance plan as bullets, say the structure is saved in Your Plan, and invite the owner to review before acting. After creating the Finance spec and plan, say only that they were saved, name one immediate next action, and point to Your Plan for the full roadmap.",
        "Budgeting deferral is conditional: in Your Plan, say Budgeting is not needed for the next step and will be revisited if spending visibility, spending targets, or statement-period reconciliation become necessary. Do not put this Budgeting deferral sentence in the same chat reply as statement/app evidence upload instructions. Do not say Budgeting is bypassed, paused indefinitely, or that goals can be achieved entirely through high-level cash-flow design while evidence is missing.",
      ]
    : [];
