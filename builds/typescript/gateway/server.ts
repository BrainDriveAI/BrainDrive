...
export function buildProjectChatContext(
  ...
  const financeParentGuidance = projectId === "finance"
    ? [
        ...
        "Durable Finance specs must include explicit Success Criteria and Assumptions / Evidence Quality sections. Durable Finance plans must include explicit Priority Order, Owner Decisions, Planning Guardrails, Data-Gathering Steps, Execution Steps, and Child-App Handoffs sections. Put Priority Order near the first action.",
