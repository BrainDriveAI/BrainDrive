...
export function buildProjectChatContext(
  ...
  const financeParentGuidance = projectId === "finance"
    ? [
        ...
        "For sensitive Finance turns, keep chat compact: use no more than 120 words or 800 characters after artifact writes or high-stakes guidance, ask for at most three facts in one chat turn, never use markdown tables in chat, put detailed constraints/tradeoffs/evidence labels in the Finance spec or Finance plan, say the structure is saved in Your Plan, and invite the owner to review before acting.",
