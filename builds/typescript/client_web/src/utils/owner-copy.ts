...
const FINANCE_CONFIDENCE_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\bContributions\s*\([^)]*withdraw[^)]*\)\s*stay invested\.\s*Earnings stay invested\./gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff."],
  [/\bContributions stay invested\.\s*Earnings stay invested\./gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff."],
  ...
  [/\bWe will preserve those retirement assets as they are, without touching or withdrawing them\.[^.\n]*\./gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff."],
...
function normalizeMalformedMarkdownSpacing(text: string): string {
  return text
    ...
    .replace(/How the Roth IRA factors \(and doesn't\) into this plan:\s*\|\s*Does factor in\s*\|\s*Does NOT factor in\s*\|[\s\S]*?(?=\s*Bottom line:|$)/gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff.\n\n")
    .replace(/How it factors \(or doesn't\) in this plan:\s*\|\s*Aspect\s*\|\s*Treatment in This Plan\s*\|[\s\S]*?(?=\s*Why this boundary exists:|$)/gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff.\n\n")
