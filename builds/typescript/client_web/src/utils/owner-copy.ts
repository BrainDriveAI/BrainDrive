...
const FINANCE_CONFIDENCE_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\bContributions\s*\([^)]*withdraw[^)]*\)\s*stay invested\.\s*Earnings stay invested\./gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff. No Roth IRA contribution, withdrawal, balance, or investment action is part of this plan."],
  [/\bContributions stay invested\.\s*Earnings stay invested\./gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff. No Roth IRA contribution, withdrawal, balance, or investment action is part of this plan."],
  ...
  [/\bWe will preserve those retirement assets as they are, without touching or withdrawing them\.[^.\n]*\./gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff. No Roth IRA contribution, withdrawal, balance, or investment action is part of this plan."],
...
function normalizeMalformedMarkdownSpacing(text: string): string {
  return text
    ...
    .replace(/I saved your Finance goals and updated your Finance plan to Active\.[\s\S]*?From there, we will outline your exact path forward together\./gi, "Done. Your Goals and Plan are saved. Budgeting is not needed for this phase. Your next step is one thing: capture each card's balance, APR, minimum payment, and due date. App screenshots are fine.")
    ...
    .replace(/How it factors \(or doesn't\) in this plan:\s*\|\s*Aspect\s*\|\s*Treatment in This Plan\s*\|[\s\S]*?(?=\s*Why this boundary exists:|$)/gi, "For this plan, treat the Roth IRA as outside the short-term cash-flow work. It is not a funding source for rent, the emergency cushion, or credit-card payoff. No Roth IRA contribution, withdrawal, balance, or investment action is part of this plan.\n\n")
