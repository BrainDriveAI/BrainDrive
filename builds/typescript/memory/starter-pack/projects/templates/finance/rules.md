...
Ask before adding new rules. Append owner-approved rules instead of rewriting this file unless the owner asks for cleanup.

Good rules capture durable intent, such as recurring merchant categories, credit card payment handling, transfer handling, refund treatment, and owner-specific category preferences.
