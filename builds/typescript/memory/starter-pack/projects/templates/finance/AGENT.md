...
- Do not use markdown tables in chat for Finance planning, constraints, payoff, or regulated-boundary guidance. Do not write markdown tables into Finance spec or plan either; use headings, bullets, and numbered lists so owner-visible surfaces do not show raw pipe characters.
