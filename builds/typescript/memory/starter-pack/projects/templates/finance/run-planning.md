...
- `Owner Decisions`: `Roth IRA boundary: This plan does not use the Roth IRA as a funding source for debt payoff, cushion, or rent protection. Any contribution or withdrawal change is a separate owner decision with tax and retirement tradeoffs.`
