...
Turn the Finance spec into a concrete sequence with one immediate step, a practical roadmap, and clear blockers.
...
Report what changed, update `plan.md`, add todos only for concrete next actions, and return to Finance scope.
