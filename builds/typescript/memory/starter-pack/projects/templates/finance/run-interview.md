...
Build a clear financial picture and capture the owner's goals, current reality, constraints, and missing information.
...
Start with the owner's presenting concern, then map the broader financial landscape: income, expenses, debt, savings, investments, employer benefits, major obligations, and relationship or life-transition context that affects money.
...
`spec.md` has useful owner-specific content, important unknowns are labeled, and high-stakes claims are not presented beyond the available evidence.
