...
**Status:** Active — Phase 1 — Building consistency, baseline routine
**Current Context:** [e.g., "Returning from 6-month break, knee injury constraint, 3-day target"]

## Recent Activity
- [date] Spec complete; plan created.
- [date] Owner hit 3 sessions for week 1 — good.

## Quick Reference

- Current activity baseline (truth, not aspiration)
- Diet pattern
- Sleep hours / quality
- Constraints (injuries, schedule, equipment)
- Past attempts and why they ended
