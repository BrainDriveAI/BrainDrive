...
*Your main goal for Fitness in one clear story, in your words, plus any supporting goals that ladder up to it.*
...
*The few facts that actually shape the plan — current activity level, the key constraints (injury, time, equipment), and experience. A few sentences or bullets, not a full inventory.*
