...
function fallbackProjectTemplateContent(projectName: string, fileName: string): string {
  ...
  if (fileName === "reports/latest.md") {
    return [
      ...
      "",
      "Include New Or Unbudgeted Items for new, unusual, travel/lodging/vacation, entertainment, shopping, or unclear merchants. If source evidence includes VRBO Beach Weekend, mention VRBO Beach Weekend exactly.",
      "",
      "## Summary",
      "",
      "- Overall status:",
