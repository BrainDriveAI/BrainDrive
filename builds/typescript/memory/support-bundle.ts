...
const SUPPORT_DETAIL_ALLOWLIST = new Set([
  ...
  "fact_revision_id", "idempotency_decision", "item_count", "lifecycle_action", "next_state", "operation_id", "outcome", "owner_data_preserved", "owner_id", "owner_memory_transition", "owner_memory_outcome",
  "model_call_id", "model_class", "output_schema_id", "output_schema_version", "package_digest", "package_version", "prior_state", "prompt_policy_id", "prompt_policy_version", "publisher_id", "purpose", "recovery", "recovery_class", "removed_classes",
  ...
  "attempt_count", "revocation_generation", "grant_revision", "session_id", "target_category", "target_id", "target_state", "timestamp", "transition_event", "usage_available", "validator_codes", "view_id",
