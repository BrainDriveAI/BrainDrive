# Historical client/gateway contract

> **Historical — not current authority.** This preserves the complete pre-Milestone-3 body from `builds/typescript/client_web/src/api/CONTRACT.md` intact below. Use the [current gateway integration boundary](../integrations/gateway.md) and live source/tests for present behavior.
