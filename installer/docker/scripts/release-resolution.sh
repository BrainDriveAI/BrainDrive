...
# Callers must define ROOT_DIR and get_env_value before sourcing this file.

RELEASE_RESOLUTION_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "${RELEASE_RESOLUTION_DIR}/release-trust.sh"
...
verify_manifest_signature() {
  ...
  braindrive_verify_release_public_key "${public_key_path}"
  ensure_cosign
